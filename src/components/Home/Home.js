...
const Home = () => {
  return (
    <div>
      ...
      <Container>
        <div className="banner_preparar">
          <Row className="familia">
            <Col md={6}>
              <h1>
                Así como una familia debe preparar un presupuesto para llegar a
                fin de mes...
              </h1>
            </Col>
            <Col md={6}>
        ...
        <div className="banner_cumplir">
          <Row>
            <Col md={6}>
              <img
                className="banner_cumplir__img"
            ...
            <Col md={6}>
              <p>
                ...
                prioritarios para cumplir las funciones del GOBIERNO
              </p>
            </Col>
          </Row>
        </div>

        <div className="banner_conoce">
        ...
        <div className="presupuesto_total">
            ...
            <Col md={3}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <Card.Text>Gs. 6.562.729.598.658</Card.Text>
                  <Button variant="primary">Ver Más</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={3}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <Card.Text>Gs. 5.518.667.479.787</Card.Text>
                  <Button variant="primary">Ver Más</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={3}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <Card.Text>Gs. 8.041.969.626.615</Card.Text>
                  <Button variant="primary">Ver Más</Button>
                </Card.Body>
              </Card>
            </Col>
            <Col md={3}>
              <Card>
                ...
                <Card.Body>
                  ...
                  <Card.Text>Gs. 612.908.572.547</Card.Text>
                  <Button variant="primary">Ver Más</Button>
                </Card.Body>
              </Card>
            </Col>
