        ...
        <Row>
          <Col md={6}>
            ...
            <ul>
              ...
              <li>
                <a>Ministerio de Hacienda - Datos abiertos</a>
              </li>
              <li>
                <a>Contrataciones Públicas - Datos abiertos</a>
              </li>
              <li>
                <a>Secretaría de la Funcion Pública - Datos abiertos</a>
              </li>
              <li>
                <a>Qué Compramos</a>
              </li>
              <li>
                <a>Portal de Datos Abiertos Gubernamentales</a>
              </li>
            </ul>
          </Col>
          <Col md={6}>
